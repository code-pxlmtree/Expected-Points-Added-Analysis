...
### 3. Data Outliers
An outlier of this data are the Chicago Bears, who posted the second highest rushing EPA, yet have a negative passing EPA. One way to explain this could be that the team is solely dependent on their running game because they don't have a competent throwing quarterback, thus inflating their runnng numbers.
...
The correlation coefficient between Passing EPA and Rushing EPA is 0.296578 which indicates that while there is a **weak positive relationship** between the two metrics. So, yes, teams that are good at passing tend to be somewhat good at rushing, but this relationship isn't consistent. For one, the Minnesota Vikings, who won 14 games, have one of the best Passing EPAs as well one of the worst Rushing EPAs, showing that this is a pass-heavy team.

## Final Takeaways
1. Teams that are effective at passing the ball, tend to be effective at running it as well, probably due to the defense focusing on stopping explosive passing plays, leaving the offense more room to run the ball.
