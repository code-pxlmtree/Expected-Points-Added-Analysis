...
Expected points added is a metric in American Football analytics for calculating how much a specific play contributed to a team's chance of winning. The 2 main ways to score points and win being 1. Passing the ball and 2. Running the ball. We will use the 2022 NFL Season's play by play data in order to answer a couple of questions regarding expected points added.

## Key Questions
1. Do teams with a high passing EPA also have a high rushing EPA
